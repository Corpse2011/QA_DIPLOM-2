...
**3. Заявка "Оплата по карте", значение всех полей пусто**
...
*Шаги:*
    ...
    7. В поле "Владелец" ввести: пусто
    8. В поле "CVC/CVV" ввести: пусто
    9. Нажать кнопку "Продолжить"

*Ожидаемый результат:* отправка формы невозможна, предупреждение "Неверный формат" под всеми полями
...
*Шаги:*
    ...
    5. В поле "Месяц" ввести: 08
    6. В поле "Год" ввести: 22
    7. Поле "Владелец" ввести: Ivanov123
    8. В поле "CVC/CVV" ввести: 999
    9. Нажать кнопку "Продолжить"
